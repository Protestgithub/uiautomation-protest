Feature: Operator To Channel Initiation for churn
    ...
    # test case tags
    @test
    Scenario:TC_383 To verify that System admin can initiate the O2C successfully if valid details are entered.
    ...
    Scenario:TC_384 To verify that O2C transfer after initiation for amount transfer should go for Approval 1.
