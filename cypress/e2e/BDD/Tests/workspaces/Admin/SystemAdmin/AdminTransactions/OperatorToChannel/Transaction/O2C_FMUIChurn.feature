Feature: O2C for churn
    ...
    # test case tags
    @test
    Scenario:TC_381 To verify that System admin can initiate the O2C allocation successfully if valid details are entered.
    ...
    # test case tags
    @test
    Scenario:TC_382 To verify that System admin checker is able to approve the O2C allocation
