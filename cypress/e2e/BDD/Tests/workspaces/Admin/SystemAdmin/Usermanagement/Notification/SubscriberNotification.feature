Feature: Notification sent on modifying Subscriber
    ...
    Scenario:TC_118 To verify that modification message is sent to Subscriber successfully.
    ...
    Scenario:TC_119 To verify that message is sent to Subscriber successfully on approval
