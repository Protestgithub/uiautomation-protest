...
#Scenario_ID :608
    ...
    #test case tags
    #@test
#Scenario:TC_751 Creation of Discount Rule
...
#Scenario_ID :608
    ...
    #test case tags
    #@test
#Scenario:TC_752 Creation of Taxation Rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
        #And Click on the C2C Service Policy
...
#Scenario_ID :608
    ...
    #test case tags
    #@test
#Scenario:TC_753 Creation of Commission rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
...
#Scenario_ID :608
    ...
    #test case tags
    #@test
#Scenario:TC_754 Creation of Transaction tax rule
...
#Scenario_ID :608
    ...
    #test case tags
    #@test
#Scenario:TC_755 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed.
...
#Scenario_ID :608
    ...
    #test case tags
    #@test
#Scenario:TC_756 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed.
        #Given Login into Mobiquity Portal as System admin Maker
