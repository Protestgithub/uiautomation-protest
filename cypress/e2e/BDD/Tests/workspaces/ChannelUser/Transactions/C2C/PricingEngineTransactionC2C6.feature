...
#Scenario_ID :609
    ...
    #test case tags
    #@test
#Scenario:TC_757 Creation of Discount Rule
...
#Scenario_ID :609
    ...
    #test case tags
    #@test
#Scenario:TC_758 Creation of Taxation Rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
        #And Click on the C2C Service Policy
...
#Scenario_ID :609
    ...
    #test case tags
    #@test
#Scenario:TC_759 Creation of Commission rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
...
#Scenario_ID :609
    ...
    #test case tags
    #@test
#Scenario:TC_760 Creation of Transaction tax rule
...
#Scenario_ID :609
    ...
    #test case tags
    #@test
#Scenario:TC_761 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed
...
#Scenario_ID :609
    ...
    #test case tags
    #@test
#Scenario:TC_762 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed  
        #Given Login into Mobiquity Portal as System admin Maker
