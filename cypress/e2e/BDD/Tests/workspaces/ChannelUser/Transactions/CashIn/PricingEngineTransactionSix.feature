...
#Scenario_ID :668
    ...
    #test case tags
    #@test
#Scenario:TC_717 Creation of Discount Rule
...
#Scenario_ID :668
    ...
    #test case tags
    #@test
#Scenario:TC_718 Creation of Taxation Rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
        #And Click on the Service Policy
...
#Scenario_ID :668
    ...
    #test case tags
    #@test
#Scenario:TC_719 Creation of Commission rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
...
#Scenario_ID :668
    ...
    #test case tags
    #@test
#Scenario:TC_720 Creation of Transaction tax rule
...
#Scenario_ID :668
    ...
    #test case tags
    #@test
#Scenario:TC_544 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed
...
#Scenario_ID :668
    ...
    #test case tags
    #@test
#Scenario:TC_721 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed  
        #Given Login into Mobiquity Portal as System admin Maker
