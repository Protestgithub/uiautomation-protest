...
#Scenario_ID :667
    ...
    #test case tags
    #@test
#Scenario:TC_664 Creation of Discount Rule
...
#Scenario_ID :667
    ...
    #test case tags
    #@test
#Scenario:TC_665 Creation of Taxation Rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
        #And Click on the Service Policy
...
#Scenario_ID :667
    ...
    #test case tags
    #@test
#Scenario:TC_666 Creation of Commission rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
...
#Scenario_ID :667
    ...
    #test case tags
    #@test
#Scenario:TC_667 Creation of Transaction tax rule
...
#Scenario_ID :667
    ...
    #test case tags
    #@test
#Scenario:TC_543 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed.
...
#Scenario_ID :667
    ...
    #test case tags
    #@test
#Scenario:TC_668 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed.
        #Given Login into Mobiquity Portal as System admin Maker
