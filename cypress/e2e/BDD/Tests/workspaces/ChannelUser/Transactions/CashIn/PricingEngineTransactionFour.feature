...
#Scenario_ID :666
    ...
    #test case tags
    #@test
#Scenario:TC_659 Creation of Discount Rule
...
#Scenario_ID :666
    ...
    #test case tags
    #@test
#Scenario:TC_660 Creation of Taxation Rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
        #And Click on the Service Policy
...
#Scenario_ID :666
    ...
    #test case tags
    #@test
#Scenario:TC_661 Creation of Commission rule
        #Given Login into Mobiquity Portal as System admin Maker
        #When Click on Pricing Engine
...
#Scenario_ID :666
    ...
    #test case tags
    #@test
#Scenario:TC_662 Creation of Transaction tax rule
...
#Scenario_ID :666
  #TAGS
    ...
    #test case tags
    #@test
#Scenario:TC_542 To verify that the transaction will be successful When only Service Charge Fixed is defined and Commission Fixed is defined
...
#Scenario_ID :666
    ...
    #test case tags
    #@test
#Scenario:TC_663 To verify that the transaction will be successful When only Service Charge Fixed is defined and Commission Fixed is defined
        #Given Login into Mobiquity Portal as System admin Maker
