Feature: Pricing Engine CashOut Transaction
...
#Scenario_ID :807
    ...
    #test case tags
    #@test
#Scenario:TC_551 To verify that the transaction will be succesful When only Service Charge fixed is defined and Commission fixed is defined
