Feature: ServiceCharge CashOut 7
...
#Scenario_ID :814
    ...
    #test case tags
    #@test
#Scenario:TC_557 To verify that tax should successful and tax will be deducted from receiver when payee is having 0 balance When Multiple Commission is define (% and fixed). And % and fixed both the Service
