Feature: ServiceCharge CashOut 6
...
#Scenario_ID :811
    ...
    #test case tags
    #@test
#Scenario:TC_555 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed
