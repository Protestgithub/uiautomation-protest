...
# Scenario_ID :808
    ...
    # test case tags
    @test
Scenario:TC_552 To verify that the transaction will be succesful When both the combination is defined like Service Charge % and fixed and Commission % and fixed
