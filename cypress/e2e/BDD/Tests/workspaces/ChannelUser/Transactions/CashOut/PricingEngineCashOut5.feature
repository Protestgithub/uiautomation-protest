Feature: ServiceCharge CashOut 5 
...
#Scenario_ID :810
    ...
    #test case tags
    #@test
#Scenario:TC_554 To verify that the transaction will be successful When both the combination is defined like Service Charge % and fixed and Commission % and fixed.
