...
Feature: ServiceCharge CashOut 4
...
#Scenario_ID :809
    ...
    #test case tags
    #@test
#Scenario:TC_553 To verify that the transaction will be successful When only Service Charge Fixed is defined and Commission Fixed is defined
