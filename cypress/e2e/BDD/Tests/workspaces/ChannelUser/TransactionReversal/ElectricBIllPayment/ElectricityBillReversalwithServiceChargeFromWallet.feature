Feature: Electric Bill Payment Reversal with ServiceCharge Reversal
...
Scenario: To verify user shall be able to perform Electricity BillPayment for ServiceCharge Reversal
...
Then Get BillPayment TransactionId4
Given Login into Consumer Portal
...
And Search Electric bill payment transaction using TransactionId4
