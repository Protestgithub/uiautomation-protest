Feature: Electric Bill Payment Reversal with Commission and ServiceCharge Reversal
...
Scenario: To verify user shall be able to perform Electricity BillPayment for Commission and ServiceCharge Reversal
...
Then Get BillPayment TransactionId3
Given Login into Consumer Portal
...
And Search Electric bill payment transaction using TransactionId3
