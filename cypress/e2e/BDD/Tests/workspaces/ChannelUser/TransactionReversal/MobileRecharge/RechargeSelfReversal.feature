Feature: Recharge-Self Transaction reversal with Commission and ServiceCharge
    ...
    @test
    ##########  Recharge-Self  ###########
    Scenario: To verify that System admin is able to Delete Service Charge for Recharge-Self
        Given Login into Mobiquity Portal as System admin Maker
        When Click on Pricing Engine
        And Click on Recharge-Self
    ...
    # test case tags
    @test
    Scenario: To verify that System admin should be able to add initiate service charge for Recharge-Self through Pricing engine module successfully.
        Given Login into Mobiquity Portal as System admin Maker
        When Click on Pricing Engine
        And Click on Recharge-Self
    ...
    @test
    ##########  Recharge-Self  ###########
    Scenario: To verify that System admin is able to Delete Commission for Recharge-Self.
        Given Login into Mobiquity Portal as System admin Maker
        When Click on Pricing Engine
    ...
    # test case tags
    @test
    Scenario: To verify that user should also be able to define commission rule for Recharge-Self.
        Given Login into Mobiquity Portal as System admin Maker
        When Click on Pricing Engine
        And Click on commission
        And Click on Recharge-Self
...
And Fill all the details for Mobile Recharge-Self and proceed
And Enter the Pin and verify transaction for Recharge-Self
