Feature: International Money Transfer Reversal with Commission
...
Scenario: To Verify System Admin user should be able to Initiate IMT Transaction reversal with Commission.
...
Scenario: To Verify user able to Approve IMT Transaction Reversal with Commission
...
Scenario: To verify system admin user able to perform Ambiguous IMT FulfillmentReversal settlement Initiation along with Commission
Given Login into Mobiquity Portal as System admin Maker
...
Scenario: To verify system admin user able to perform Ambiguous IMT FulfillmentReversal settlement approval along with Commission
Given Login into Mobiquity Portal as System admin Checker1
