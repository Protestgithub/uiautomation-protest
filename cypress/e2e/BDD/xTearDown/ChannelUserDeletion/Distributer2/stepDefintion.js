...
And('Enter Mobile number4 or KYC number of Business user created for suspension in Search', function () {
  pageLogin.getiFrame()
...
Then('Verify Sucess Message of BusinessUser Deletion', function () {
  cy.waitUntil(() => {
...
//   })
//--------------------------------------------------------------------------------------------------------
And('Assert Created BusinessReg Suspended Mobile Number and Write Created on time', function () {
...
And('User click on submitted user data for BuisnessRegSuspension', function () {
