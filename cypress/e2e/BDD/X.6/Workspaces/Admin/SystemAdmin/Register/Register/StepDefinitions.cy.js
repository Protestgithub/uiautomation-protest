...
//     cy.wait(3000)
//     registerPage.getBankAccount().contains('Bank Account')
   
//     })
   
//     And('Assert Bank Name',()=>{
//      cy.wait(3000)
//      registerPage.getBankName().contains('Bank Name')
//     })
...
//         registerPage.getNextButtonKYC().click({ multiple: true })
//         registerPage.getNextHierarchy().click()
//         registerPage.getNextButtonProfile().click()
//        })

//        And('Enter The Account Number',()=>{
//         cy.wait(3000)
//         registerPage.getAccountNum().type(4356765786)
//         registerPage.getAccountNum().clear()
//         registerPage.getAccountNum().type(3456456775)
//        })